...
public class PlayerNotificationUtil {
         ...
         * @return
         */
        public static NotificationCompat.Builder from(Activity activity, Context context,
                        MediaSessionCompat mediaSession, String notificationChannelId) {
                ...
                int smallIcon = context.getResources().getIdentifier("ic_notification_icon", "drawable",
                ...
                builder.setContentTitle(description.getTitle()).setContentText(description.getSubtitle())
                                ...
                                .setVisibility(NotificationCompat.VISIBILITY_PUBLIC).setSmallIcon(smallIcon)
